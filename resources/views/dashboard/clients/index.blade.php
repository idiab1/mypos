            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a class="btn btn-primary btn-crayons btn-add-new float-right" href="{{route('client.create')}}">
            ...
            <div class="row">
                <div class="col-12 m-auto">
                    <div class="empty-section text-center">
                        ...
                        <a class="btn btn-primary btn-crayons btn-add-new" href="{{route('client.create')}}">
                            <i class="fas fa-plus"></i> {{trans('site.add_new_client')}}
                        </a>
                    </div>
                </div>
